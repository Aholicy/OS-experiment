...
extern "C" void c_time_interrupt_handler()
{
    ...
    char name[]="20337263yuzebin";
    int namepos=(times-1)%15;
    char number[10];
    int temp = times;
	...
	k=i%8;
    	int j=0;
    	stdio.moveCursor(80+namepos);
    	stdio.print(name[namepos],col[k]); 
    	while(j<80000){
  		j++;  	
    	}
    	stdio.moveCursor(80+namepos);
    ...
    for(int i=0;i<15;++i){
    	stdio.moveCursor(160+namepos);
    	stdio.print(name[namepos]); 
